    ...
    if (!ready) {
        return (
            <div role="status">
                ...
                <span className="sr-only">Recupero le credenziali...</span>
            </div>
        )
    }
...
export default function AdminRoutes({setAlert}) {
    return (
        <Routes>
            ...
            <Route path="/admin/clienti" element={
                <AdminGuard>
                    <GestioneClienti setAlert={setAlert} />
                </AdminGuard>
            } />
            <Route path="/admin/scheda/:id" element={
                <AdminGuard>
                    <GestioneSchedaUtente setAlert={setAlert}/>
                </AdminGuard>
            } />
